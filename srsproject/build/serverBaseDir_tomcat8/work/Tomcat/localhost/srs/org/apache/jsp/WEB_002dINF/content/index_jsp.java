 ...
 * Generated at: 2017-07-03 18:08:41 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t$.ajax({\n");
      out.write("\t\t\turl:'userAction_login',\n");
      out.write("\t\t\ttype:'POST',\n");
      ...
      out.write("\t\t\t\t\t\twindow.location.href='student?'+ ssn +'';\n");
      out.write("\t\t\t\t\t}else if($(\"#select\").val()==\"Professor\"){\n");
      out.write("\t\t\t\t\t\twindow.location.href='professor?'+ ssn +''\n");
      out.write("\t\t\t\t\t}else{\n");
